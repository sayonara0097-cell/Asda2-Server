...
namespace WCell.Constants.World
{
  ...
  public enum MapId
  {
    ...
    Guildwave = 28, // 0x0000001C
    Testing = Guildwave,
    Fantagle = 29, // 0x0000001D
    WindCanyon = 30, // 0x0000001E
    Astrica = 31, // 0x0000001F
    Elysion = 32, // 0x00000020
    Acanpolis = 33, // 0x00000021
    Labyrinthos = 34, // 0x00000022
