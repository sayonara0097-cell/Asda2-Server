...
namespace WCell.Constants.World
{
  public static class MapBoundaries
  {
    public static BoundingBox[] GetMapBoundaries()
    {
      ...
      boundingBoxArray[(int) MapId.Guildwave] =
        new BoundingBox(new Vector3(28000f, 28000f, -2048f), new Vector3(28500f, 28500f, 2048f));
      boundingBoxArray[(int) MapId.Fantagle] =
        new BoundingBox(new Vector3(29000f, 29000f, -2048f), new Vector3(29500f, 29500f, 2048f));
      boundingBoxArray[(int) MapId.WindCanyon] =
        new BoundingBox(new Vector3(30000f, 30000f, -2048f), new Vector3(30500f, 30500f, 2048f));
      boundingBoxArray[(int) MapId.Astrica] =
        new BoundingBox(new Vector3(31000f, 31000f, -2048f), new Vector3(31500f, 31500f, 2048f));
      boundingBoxArray[(int) MapId.Elysion] =
        new BoundingBox(new Vector3(32000f, 32000f, -2048f), new Vector3(32500f, 32500f, 2048f));
      boundingBoxArray[(int) MapId.Acanpolis] =
        new BoundingBox(new Vector3(33000f, 33000f, -2048f), new Vector3(33500f, 33500f, 2048f));
      boundingBoxArray[(int) MapId.Labyrinthos] =
        new BoundingBox(new Vector3(34000f, 34000f, -2048f), new Vector3(34500f, 34500f, 2048f));
