    ...
    public static class Asda2SoulmateHandler
    {
      ...
      byte.MaxValue
        ...
        public static void SendCharacterSoulMateIntrodactionUpdateResponse(IRealmClient client)
        {
            ...
            {
                packet.WriteInt32(-1);
                packet.WriteFixedAsciiString(client.ActiveCharacter.SoulmateIntroduction ?? "", sbyte.MaxValue,
                  Locale.Start);
                packet.WriteByte(1);
        ...
        {
            string message = packet.ReadAsdaString(sbyte.MaxValue, Locale.Start);
        ...
        {
            List<Character> list = client.ActiveCharacter.Map.Characters.ToList();
            list.Remove(client.ActiveCharacter);
            int val1 = list.Count / 7;
            if (val1 == 0)
                val1 = 1;
            IEnumerable<Character> characters = list.Skip((page - 1) * 7).Take(7);
        ...
        public static void SoulmateRequestRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            if (character == null)
                client.ActiveCharacter.SendSystemMessage(string.Format("Cant add soulmate cause not found by name {0}",
                  name));
            else if (character.Asda2FactionId != client.ActiveCharacter.Asda2FactionId)
                ...
                SendSoulmateRequestResponseResponse(client,
                  SoulmateRequestResponseResult.TargetAlreadyHasASoulmate, activeCharacter.AccId,
                  activeCharacter.Name, 0, 0, 0, "");
            else if (character.IsSoulmated)
                SendSoulmateRequestResponseResponse(client,
                  SoulmateRequestResponseResult.TargetAlreadyHasASoulmate, character.AccId, character.Name, 0,
                  0, 0, "");
            else
                SendSoulmateRequestResponseResponse(character.Client,
        ...
        public static void DisbandSoulMateRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            if (activeCharacter.IsSoulmated)
            {
                ...
                SendDisbandSoulMateResultResponse(client,
        ...
        public static void SendSoulmateEnterdGameResponse(IRealmClient client)
        {
            ...
            using (RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SoulmateEnterdGame))
            {
                ...
                for (int index = 0; index < 28; ++index)
                {
                    ...
                    packet.WriteByte(0);
                    packet.WriteInt32(visibleAuras[index] == null ? -1 : visibleAuras[index].Spell.RealId);
                }
        ...
        public static void SendSoulMateHpMpUpdateResponse(IRealmClient client)
        {
            ...
            using (RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SoulMateHpMpUpdate))
            {
                ...
                packet.WriteInt64(client.ActiveCharacter.Experience);
                packet.WriteByte(0);
                packet.WriteByte((byte)soulmateCharacter.MapId);
                packet.WriteInt16(0);
                packet.WriteInt64((long)client.ActiveCharacter.SoulmateRecord.Expirience);
                packet.WriteInt64(client.ActiveCharacter.SoulmateRecord.Level);
                packet.WriteSkip(stab52);
        ...
        public static void SendSoulmatePositionResponse(IRealmClient client)
        {
            ...
            if (soulmateCharacter == null || soulmateCharacter.SoulmateRecord == null || client.ActiveCharacter == null)
                return;
            if (client.Channel != soulmateCharacter.Client.Channel)
                return;
                ...
                foreach (Asda2SoulmateRelationRecord soulmateRelationRecord in soulmateRecords)
                {
                    if (num < 3)
                    {
                        CharacterRecord[] allByProperty = ActiveRecordBase<CharacterRecord>.FindAllByProperty(
                          "AccountId",
                          (int)soulmateRelationRecord.AccId == (int)client.ActiveCharacter.AccId
                            ? (int)soulmateRelationRecord.RelatedAccId
                            : (int)soulmateRelationRecord.AccId);
                        for (int index = 0; index < 3; ++index)
                        {
                            CharacterRecord characterRecord = allByProperty.Get(index);
                            ...
                            packet.WriteByte(characterRecord == null ? 0 : characterRecord.ProfessionLevel);
        ...
        public static void SendSoulMateInfoInitResponse(Character rcv, bool showFriendWindow)
        {
            using (RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SoulMateInfoInit))
            {
                ...
                packet.WriteInt16(rcv.SoulmateCharacter == null ? 0 : rcv.SoulmateCharacter.SessionId);
                packet.WriteInt16(1);
                packet.WriteByte(1);
                packet.WriteByte(3);
                packet.WriteByte(2);
        ...
        public static int AppleSector = 0;
        ...
        public static void EatAppleRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            if (client.ActiveCharacter.EatingAppleStep == 0)
            {
                lock (soulmateRecord)
                {
                    ...
                    {
                        SendAppleEatResultResponse(client, AppleEatResult.Fail,
                          AppleBonusType.Fail, 0, null);
                        return;
                    }
                ...
                byte sector = (byte) Utility.Random(0, 3);
                AppleSector = sector;
                byte record = (byte)(sector == 0 || sector == 2 ? 1 : sector == 1 ? 3 : 2);
                client.ActiveCharacter.EatingAppleStep = (byte)(sector == 1 ? 2 : 1);
                SendAppleRandomResponse(client, sector, record);
            }
            else if (client.ActiveCharacter.EatingAppleStep == 1)
            {
                byte sector = (byte)Utility.Random(0, 3);
                byte record = (byte)(AppleSector == 0 || AppleSector == 2 ? 1 : AppleSector == 1 ? 3 : 2);
                client.ActiveCharacter.AppleSector = sector;
                client.ActiveCharacter.EatingAppleStep = (byte)2;
                SendAppleRandomResponse(client, sector, (byte)record);
            }
        }
        ...
        public static void GetApplePrizeRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            int num3 = client.ActiveCharacter.SoulmateCharacter != null ? num1 * client.ActiveCharacter.SoulmateCharacter.Level / lvl : 1;
            if (client.ActiveCharacter.EatingAppleStep == 2)
            {
                client.ActiveCharacter.EatingAppleStep = 0;
                if (AppleSector == 0 || AppleSector == 2)
                {
                    client.ActiveCharacter.GainXp(num2, "apple", false);
                    SendAppleEatResultResponse(client, AppleEatResult.Ok, AppleBonusType.Exp, num2, null);
                    if (client.ActiveCharacter.SoulmateCharacter == null)
                        return;
                    client.ActiveCharacter.SoulmateCharacter.GainXp(num3, "apple", false);
                    SendAppleEatResultResponse(client.ActiveCharacter.SoulmateCharacter.Client, AppleEatResult.Ok, AppleBonusType.Exp, num3, null);
                }
                else if (AppleSector == 1)
                {
                    client.ActiveCharacter.Health = client.ActiveCharacter.MaxHealth;
                    client.ActiveCharacter.Power = client.ActiveCharacter.Power;
                    SendAppleEatResultResponse(client, AppleEatResult.Ok, AppleBonusType.RestoreHPandMP, num2, null);
                }
                else if (AppleSector == 3)
                {
                    int[] items = { 20686, 20590, 31920, 34094 };
                    int itemId = items[client.ActiveCharacter.AppleSector];
                    Asda2Item item = null;
                    client.ActiveCharacter.Asda2Inventory.TryAdd(itemId, client.ActiveCharacter.AppleSector == 1 ? 5 : 1 , true, ref item);
                    SendAppleEatResultResponse(client, AppleEatResult.Ok, AppleBonusType.Item, num2, item);
                }
            }
            else
        ...
        public static void SendSoulmateMessageRequest(IRealmClient client, RealmPacketIn packet)
        {
               ...
               client.ActiveCharacter.SoulmateCharacter.Client.IsConnected)
            {
                ...
                {
                    SendIncomingSoulmateMessageResponse(client.ActiveCharacter.SoulmateCharacter,
                      str, locale);
        ...
        public static void UseSoulmateSkillRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            if (client.ActiveCharacter.SoulmateCharacter == null)
                SendSoulmateSkillUsedResponse(client, UseSoulmateSkillStatus.FriendNotInGame,
                  0, 0);
            else if (client.ActiveCharacter.IsDead)
            {
                SendSoulmateSkillUsedResponse(client, UseSoulmateSkillStatus.YouAreDead, 0,
                  0);
            }
            else
            {
                ...
                if (!soulmateRecord.Skills.ContainsKey((Asda2SoulmateSkillId)skillId))
                    SendSoulmateSkillUsedResponse(client, UseSoulmateSkillStatus.Fail, 0,
                      0);
                  ...
                  client.ActiveCharacter.SoulmateCharacter))
                {
                    ...
                    SendSoulmateSkillUsedResponse(client, UseSoulmateSkillStatus.Ok, skillId,
                      targetSessId);
                    SendSoulmateSkillUsedResponse(client.ActiveCharacter.SoulmateCharacter.Client,
        ...
        public static void SendSoulmateSkillCastResponse(Character caster, short targetSessId, short skillId)
        {
            using (RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SoulmateSkillCast))
            {
                ...
                packet.WriteSkip(unk7);
                packet.WriteInt16(targetSessId);
                packet.WriteInt16(targetSessId);
                packet.WriteSkip(unk10);
                packet.WriteByte((byte)caster.MapId);
                packet.WriteSkip(stab186);
          ...
          short skillId, short targetSessId)
        {
            using (RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.SoulmateSkillUsed))
            {
                ...
                packet.WriteInt16(targetSessId);
                packet.WriteInt16(targetSessId);
                packet.WriteSkip(unk11);
                packet.WriteByte((byte)client.ActiveCharacter.MapId);
                packet.WriteSkip(stub180);
                client.Send(packet, true);
                if (client.ActiveCharacter.SoulmateCharacter == null)
                    return;
                client.ActiveCharacter.SoulmateCharacter.Send(packet, true);
