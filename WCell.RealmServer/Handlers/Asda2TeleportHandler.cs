...
namespace WCell.RealmServer.Handlers
{
  public static class Asda2TeleportHandler
  {
    ...
    {
      if(client == null || !client.IsConnected || client.ActiveCharacter == null ||
         client.ActiveCharacter.TeleportPoints == null)
        return;
      ...
      {
        packet.WriteByte(1);
        for(int index = 0; index < character.TeleportPoints.Length; ++index)
        {
          Asda2TeleportingPointRecord teleportPoint = character.TeleportPoints[index];
