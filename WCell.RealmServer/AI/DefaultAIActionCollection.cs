...
namespace WCell.RealmServer.AI
{
  public class DefaultAIActionCollection : AIActionCollection
  {
    ...
    {
      base.Init(owner);
      var roamWaypoints = owner.Waypoints;
      NPC roamingNpc = owner as NPC;
      if(roamingNpc != null && roamingNpc.SpawnEntry != null)
        roamWaypoints = roamingNpc.SpawnEntry.CreateWaypointsForSpawn();
      ...
      {
        Strategy = (AIAction) new AIWaypointMoveAction(owner, AIMovementType.ForwardThenBack, roamWaypoints)
      };
