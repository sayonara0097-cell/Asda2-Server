...
namespace WCell.RealmServer.AI.Actions.Movement
{
  ...
  public class AIWaypointMoveAction : AIAction
  {
    ...
    protected void MoveToTargetWaypoint()
    {
      ...
      {
        this.StayingOnWaypoint = true;
        this.DesiredStartMovingTime = Utility.GetSystemTime() + 1000U;
        return;
      }
      if(!this.m_owner.CanMove)
      {
        this.StayingOnWaypoint = true;
        this.DesiredStartMovingTime = Utility.GetSystemTime() + 1000U;
        return;
      ...
      if(this.m_owner.Movement.MoveTo(this.TargetWaypoint.Value.Position, false))
        this.ArriveAtTargetWaypoint();
      else if(!this.m_owner.Movement.IsMoving)
      {
        this.StayingOnWaypoint = true;
        this.DesiredStartMovingTime = Utility.GetSystemTime() + 1000U;
      }
    ...
    protected void ArriveAtTargetWaypoint()
    {
      ...
      uint waitTime = this.CurrentWaypoint.Value.WaitTime;
      this.StayingOnWaypoint = true;
