...
namespace WCell.RealmServer.Handlers
{
  ...
  public class GuildSkill : WCellRecord<GuildSkill>
  {
    ...
    {
      get { return Template == null || Level >= Template.MaxLevel; }
    }
    ...
    public int NextLearnCost
    {
      get
      {
        ...
        if(!IsMaxLevel && Template != null && Template.LearnCosts.Length > nextLevel)
          return Template.LearnCosts[nextLevel];
        return int.MaxValue;
      }
    }
    ...
    public int ActivationCost
    {
      get
      {
        if(Template != null && Template.ActivationCosts.Length > Level)
          return Template.ActivationCosts[Level];
        return int.MaxValue;
      }
    }
    ...
    public int MaintanceCost
    {
      get
      {
        if(Template != null && Template.MaitenceCosts.Length > Level)
          return Template.MaitenceCosts[Level];
        return int.MaxValue;
      }
    }
    ...
    public int ValueOnUse
    {
      get
      {
        if(Template == null || Template.BonusValuses.Length == 0)
          return 0;
        int level = Math.Min(Level, Template.BonusValuses.Length - 1);
        return (int) (Template.BonusValuses[level] *
                      Math.Pow(Guild.Level, 0.5));
      }
    }
