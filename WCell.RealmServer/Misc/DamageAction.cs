...
namespace WCell.RealmServer.Misc
{
  ...
  public class DamageAction : IDamageAction, IUnitAction
  {
    ...
    private int m_actualDamageOverride = -1;
    ...
    public int ActualDamage
    {
      get
      {
        if(m_actualDamageOverride >= 0)
          return m_actualDamageOverride;
    ...
    internal void SetActualDamageOverride(int actualDamage)
    {
      m_actualDamageOverride = Math.Max(0, actualDamage);
    }

    internal void ClearActualDamageOverride()
    {
      m_actualDamageOverride = -1;
    }
    ...
    public ProcHitFlags DoAttack()
    {
      ...
      if(Victim.HasLastResortProtectionAgainst(Attacker))
      {
        Miss();
        return ProcHitFlags;
      }
    ...
    {
      Damage = 0;
      VictimState = VictimState.Miss;
      HitFlags = HitFlags.Miss;
      ProcHitFlags |= ProcHitFlags.Miss;
      Blocked = 0;
      IsCritical = false;
      SetActualDamageOverride(0);
      DoStrike();
    }
