    ...
    public static class Asda2PetHandler
    {
        ...
        public static void SendPetResurectedResponse(IRealmClient client, Asda2PetRecord pet, Asda2Item resurectPetItem)
        {
            ...
            using (RealmPacketOut packet = new RealmPacketOut(RealmServerOpCode.PetResurected))
            {
                ...
                packet.WriteInt32(resurectPetItem.IsDeleted ? 0 : resurectPetItem.Amount);
                packet.WriteByte(0);
        ...
        public static void PetSyntesRequest(IRealmClient client, RealmPacketIn packet)
        {
            ...
            {
                Asda2Item regularItem1 = num1 == 1 ? client.ActiveCharacter.Asda2Inventory.GetShopShopItem(slotInq1) : client.ActiveCharacter.Asda2Inventory.GetRegularItem(slotInq1);
                ...
                else if (num1 != 1 && regularItem1.Template.Category != Asda2ItemCategory.PetSynesisPotion ||
                         regularItem2 != null && regularItem2.Template.Category != Asda2ItemCategory.PetPotion)
                {
                                ...
                                .ToArray<PetTemplate>()[
                                    Utility.Random(0,
                                        Asda2PetMgr.PetTemplatesByRankAndRarity[regularItem1.Template.ValueOnUse][
                                            rarity].Count - 1)]
                            : num1 == 1 ? CalcProffPetTemplate(ownedPet1.Template, regularItem1.Template.ValueOnUse, ownedPet1.Template.Rank, ownedPet1.Template.Rarity) : ownedPet1.Template.GetEvolutionTemplate(rarity, ownedPet1.Template.Rank);
                        if (petTemplate == null)
                        {
                            if (flag)
                                client.ActiveCharacter.YouAreFuckingCheater(
        ...
        public static PetTemplate CalcProffPetTemplate(PetTemplate pet, int proff, int rank, int rarity)
        {

            if (Asda2PetMgr.PetTemplateMap.TryGetValue((pet.Id, proff, rank, rarity), out int templateId))
            {
                return Asda2PetMgr.PetTemplatesByRankAndRarity[rank][rarity].FirstOrDefault((t) => t.Value.Id == templateId).Value;
            }
