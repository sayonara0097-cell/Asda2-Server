...
namespace WCell.RealmServer.Entities
{
  public static class Targeting
  {
    ...
    public static IList<WorldObject> GetObjectsInRadius<O>(this O wObj, float radius, ObjectTypes filter,
      bool checkVisible = true, int limit = 2147483647) where O : WorldObject
    {
      if(wObj.Map == null)
      ...
      if(wObj is Character chr)
      {
          return objectsInRadius.Where((o) => o is NPC && ((NPC) o).Channel == chr.Client.Channel || o is Character && ((Character) o).Client.Channel == chr.Client.Channel).ToList();
      }
      else
      {
      ...
      where O : WorldObject
    {
      ...
      Func<Character, bool> filter = otherObj =>
      {
        if(otherObj == null || !otherObj.IsInWorld || otherObj.Client == null)
          return false;
        if(!otherObj.CanSee(obj))
          return false;
        if(obj == otherObj)
