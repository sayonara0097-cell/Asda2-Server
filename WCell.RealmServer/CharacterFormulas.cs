...
namespace WCell.RealmServer
{
  public static class CharacterFormulas
  {
    ...
    [NotVariable]public static int FishingGuildPoints = (int) (5.0 * (double) CharacterFormulas.GuildPointsMultiplier);

    [NotVariable]public static int DiggingGuildPoints = (int) (2.0 * (double) CharacterFormulas.GuildPointsMultiplier);
    ...
    [NotVariable]public static int MinPingDelay = 100;
    ...
    [NotVariable]public static double DropLiveMinutes = 1.5;
    ...
    public static ItemUpgradeResult CalculateItemUpgradeResult(Asda2ItemQuality stoneQuality,
      ...
      int nearblyCharactersLuck, bool useProtect, int useChanceBoost, bool noEnchantLose, bool isGodMode)
    {
      float num1 = 200f;
      switch(itemQuality)
      {
