  ...
  public class Asda2SoulmateRelationRecord : WCellRecord<Asda2SoulmateRelationRecord>
  {
    ...
    public void UpdateCharacters()
    {
      ...
      if(loggedInAccount1 != null && loggedInAccount1.ActiveCharacter != null)
      {
        if(!IsActive)
        {
          ...
          Asda2SoulmateHandler.SendDisbandSoulMateResultResponse(loggedInAccount1.ActiveCharacter.Client,
            DisbandSoulmateResult.SoulmateReleased, "friend");
        }
      ...
      if(!IsActive)
      {
        ...
        Asda2SoulmateHandler.SendDisbandSoulMateResultResponse(loggedInAccount2.ActiveCharacter.Client,
          DisbandSoulmateResult.SoulmateReleased, "friend");
      }
    ...
    public void OnExpGained(bool fromMonster)
    {
      ...
      if(characterByAccId1 == null || characterByAccId2 == null ||
         ...
         characterByAccId1.GetDist(characterByAccId2) > 40.0 || characterByAccId1.Client.Channel != characterByAccId2.Client.Channel)
      {
