...
namespace WCell.RealmServer.Database
{
    ...
    public class Asda2QuestRecord : WCellRecord<Asda2QuestRecord>
    {
        ...
        public static Asda2QuestRecord[] GetRecordsByMonster1Id(int id)
        {
            return FindAll(Restrictions.Eq("Monster1Id", id));
        }

        public static Asda2QuestRecord[] GetRecordsByMonster2Id(int id)
        {
            return FindAll(Restrictions.Eq("Monster2Id", id));
        }

        public static Asda2QuestRecord[] GetRecordsByMonster3Id(int id)
        {
            return FindAll(Restrictions.Eq("Monster3Id", id));
        }

        public static Asda2QuestRecord[] GetRecordsByMonster4Id(int id)
        {
            return FindAll(Restrictions.Eq("Monster4Id", id));
        }

        public static Asda2QuestRecord[] GetRecordsByMonster5Id(int id)
        {
