...
namespace WCell.RealmServer.Items
{
  ...
  public static class Asda2ItemMgr
  {
    ...
    [NotVariable]public static Dictionary<int, List<DecompositionDrop>> DecompositionDrops =
    ...
    [NotVariable]public static Dictionary<int, RegularShopRecord> AvalibleRegularShopItems =
    ...
    [NotVariable]public static Asda2GuildWaveItemRecord[] GuildWaveRewardRecords = new Asda2GuildWaveItemRecord[100000];
    ...
    {
      if((uint) id < WarShopDataRecords.Length)
        return WarShopDataRecords[(uint) id];
      return null;
    }
    ...
    {
      int startPrice = GetStartPrice(itemLevel);
      int step = GetStep(rarity);
      int num = 0;

      int baseValue = startPrice + step + (startPrice * enchLevel) + ((enchLevel + 1) * step);
      int adjustment = (enchLevel % 2 == 0) ? 0 : step;
      num = (baseValue - adjustment) + getLevel(enchLevel, step);
      return num;
    }

    private static int getLevel(int e, int step) {
        switch (e)
        {
            case 0: return -step;
            case 1: return 0;
            ...
            case 5: return step * 6;
            case 6: return step * 6;
            case 7: return step * 8;
            case 8: return step * 8;
            case 9: return step * 10;
            case 10: return step * 10;
            case 11: return step * 12;
            case 12: return step * 12;
            case 13: return step * 14;
            case 14: return step * 14;
            case 15: return step * 16;
            case 16: return step * 16;
            case 17: return step * 18;
            case 18: return step * 18; 
            case 19: return step * 20;
            case 20: return step * 19;
            default:
                return 0;
        }    
    }
    ...
    internal static void EnsureItemQuestRelations()
    {
      foreach(QuestTemplate template1 in QuestMgr.Templates)
      {
        if(template1 != null && template1.CollectableItems != null)
        {
          ...
          {
            Asda2ItemTemplate template2 = GetTemplate(collectableItem.ItemId);
            if(template2 == null)
          ...
          {
            Asda2ItemTemplate template2 = GetTemplate(collectableSourceItem.ItemId);
            if(template2 == null)
              ContentMgr.OnInvalidDBData("QuestTemplate \"{0}\" refered to non-existing Item: {1}",
      ...
      foreach(Asda2ItemTemplate template1 in Templates)
      {
    ...
    public static void InitItemSlotHandlers()
    {
      ...
      PartialInventoryTypes.Fill(PartialInventoryType.EquippedContainers, 19,
        22);
