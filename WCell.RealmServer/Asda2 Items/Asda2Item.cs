...
namespace WCell.RealmServer.Entities
{
    ...
    IAsda2MountableItem, IContextHandler
  {
    ...
    public void GenerateNewOptions()
    {
      ...
      Parametr1Type = Asda2ItemBonusType.MinDef;
    ...
    public byte EnchantResetCount
        {
      get { return IsDeleted ? (byte) 0 : m_record.EnchantResetCount; }
      set { m_record.EnchantResetCount = value; }
    }
