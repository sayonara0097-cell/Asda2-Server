    ...
    public class Asda2ItemTemplate : IDataHolder, IAsda2MountableItem, IQuestHolderEntry
    {
        ...
        public void FinalizeDataHolder()
        {
            if (this.Id == uint.MaxValue)
                return;
            this.CheckId();
            bool isBallistaQuiver = IsBallistaQuiver(this.Id);
            ...
            this.IsRangedWeapon = !isBallistaQuiver && (this.Category == Asda2ItemCategory.Crossbow ||
            ...
            this.IsTwoHandWeapon = !isBallistaQuiver && (this.Category == Asda2ItemCategory.TwoHandedSword ||
                                   this.Category == Asda2ItemCategory.Spear ||
                                   (this.Category == Asda2ItemCategory.Staff ||
                                    this.Category == Asda2ItemCategory.Crossbow) ||
                                   this.Category == Asda2ItemCategory.Bow ||
                                   this.Category == Asda2ItemCategory.Ballista);
            this.IsAmmo = this.Category == Asda2ItemCategory.BowAmmo ||
                          this.Category == Asda2ItemCategory.CrossbowAmmo ||
                          isBallistaQuiver;
        ...
        private static bool IsBallistaQuiver(uint itemId)
        {
            return itemId == 20569U || itemId == 20570U || itemId == 20571U;
        }
