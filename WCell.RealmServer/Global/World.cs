...
namespace WCell.RealmServer.Global
{
  ...
  public class World : IWorldSpace
  {
    ...
    public static void InitializeWorld()
    {
      ...
      _taskQueue.CallPeriodically(10000, GlobalHandler.SendSetClientTimeToAllIfChanged);
    ...
    {
      return CharactersByAccId.Single((c) => c.Value.Name == name).Value;
    }
